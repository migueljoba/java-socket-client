...
public class PropertiesLoader {
    ...
    /**
     * Obtener propiedad server.address
     * Utilizado para indicar la dirección del servidor del socket.
     * Valor por defecto: 127.0.0.1
     *
     * @return cadena del número del puerto
     */
    public static String getServerAddress() {
        return properties.getProperty("server.address", "127.0.0.1");
    }
    ...
    private static FileInputStream openFile() {
        ...
        String filePath = "./clientConfig.properties";
